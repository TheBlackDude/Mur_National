...
export type SnapshotItem = { id: string; type?: 'photo' | 'video'; thumbUrl: string; videoUrl?: string | null; participantNumber: number; prefecture?: string | null; country?: string | null; featured?: boolean; vip?: 'president' | 'minister' | null }
